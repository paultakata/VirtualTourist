...
extension VirtualTouristClient {
    ...
    func getPhotosForPin(pin: Pin, completionHandler: (success: Bool, error: NSError?) -> Void) {
        ...
        //If pin has photos already, generate a random page from the
        //available pages on Flickr and add it to the parameters.
        //This hopefully returns new images more often.
